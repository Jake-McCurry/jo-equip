...
export const subTopics: SubTopic[] = [
  ...
  },
  {
    ...
    items: [
      { number: 1,  title: "Uniquely God-designed Church" },
      { number: 2,  title: "A hope-filled church" },
      { number: 3,  title: "A Total Life Discipleship church" },
      { number: 4,  title: "A God-exalting church" },
      { number: 5,  title: "A Spirit-dependent church" },
      { number: 6,  title: "A life application church" },
      { number: 7,  title: "A JesusOnline media-resourced church" },
